...
@WebServlet(name = "DataSetServletSession", urlPatterns = {"/DataSetServlet2"})
public class DataSetServletSession extends HttpServlet {
	...
	private void processRequest(HttpServletRequest request, 
        ...
        DataSet data = (DataSet) s.getAttribute("data");
